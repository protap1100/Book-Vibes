const Contact = () => {
    return (
        <div className="mt-10">
            <section className="py-6 dark:bg-gray-100 dark:text-gray-900 rounded-xl">
                <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                    ...
                    <form  className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                        ...
                        <button type="button" className="self-center px-8  text-lg bg-[#23be0a] rounded-xl btn text-white  " >Submit</button>
                    </form>
                </div>
            </section>
        </div>
